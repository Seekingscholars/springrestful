...
public class UserController {
	...
	/**
	 * 跳转到添加用户页面，约定优于配置，默认匹配文件 /views/user/add.jsp
	 * RequestMethod.GET
	 * url : /add
	 */
	 ...
	 * url : /{id}
	 */
	@RequestMapping(method=RequestMethod.GET,value="{id}.html")
	 ...
	 */
	@ResponseBody
	@RequestMapping(method=RequestMethod.DELETE,value="{id}.html")
	 ...
	 */
	@ResponseBody
	@RequestMapping(method=RequestMethod.PUT,value="edit.html")
	...
	private List<User> getUserList(){
		...
		for(int i=0; i<10;i++){
			list.add(new User((i+1)+"","李四"+(i+1),"i"+(i+1)));
		}
		return list;
	}
	/**
