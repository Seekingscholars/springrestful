...
public class WebUtils {
     ...
     * @param newEncode 现编码
     */
    public static void responseJson(HttpServletResponse response, Object object, String oldEncode, String newEncode) {
        String s = JSON.toJSONString(object);
     ...
     * @param o	json对象
     */
    public static void responseJsonDf(HttpServletResponse response, Object object) {
    	String s = JSON.toJSONString(object);
